...
[![Windows CI](https://ci.appveyor.com/api/projects/status/{{PUT_APPVEYOR_STATUS_BADGE_ID_HERE}}?svg=true)](https://ci.appveyor.com/project/consolidation/filter-via-dot-access-data)
...
[![License](https://poser.pugx.org/consolidation/filter-via-dot-access-data/license)](https://github.com/consolidation/filter-via-dot-access-data//master/LICENSE)
-->
...
| Feature                   | Setup
| ------------------------- | ----------------
| Collaborative repository  | [DONE](https://github.com/consolidation/filter-via-dot-access-data)
| Linux permutation testing | [DONE](https://travis-ci.org/consolidation/filter-via-dot-access-data)
...
- [GitHub issue templates](https://github.com/consolidation/filter-via-dot-access-data/issues/templates/edit)
